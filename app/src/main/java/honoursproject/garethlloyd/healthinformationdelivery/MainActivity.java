...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        images = new int[] {R.drawable.walk_large, R.drawable.water_large, R.drawable.fruit_large, R.drawable.clock_large};
        titles = new String[]{"Steps", "Water", "Fruit and Veg", "Activity"};
        ...
        mIndicator.setPadding(60, 0, 0, 0);
